...
Beschreibung + Kommentare + Checklist) werden bei erneutem Setzen des Mode-Labels
nicht noch einmal geschickt. Neue Kommentare oder andere Inhaltsänderungen erlauben
einen Neustart.
